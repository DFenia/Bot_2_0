...
m_main = Menu("Главное меню", buttons=["Развлечения", "Возможности бота", "Помощь"])

m_DZ = Menu("Возможности бота", buttons=["Возможность-1", "Возможность-2", "Возможность-3", "Возможность-4", "Выход"], parent=m_main)

m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать котика", "Человек и email", "Прислать игру", "Выход"], parent=m_main)
